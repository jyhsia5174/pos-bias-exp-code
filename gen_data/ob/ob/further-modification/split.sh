...
head -n $small_perc_total_num ob_all_3000.ffm > $random_data &
head -n $(($small_perc_total_num + $large_perc_total_num)) ob_all_3000.ffm | tail -n $large_perc_total_num > $filter_data &
tail -n $(($total_num - $small_perc_total_num - $large_perc_total_num)) ob_all_3000.ffm > $truth_data &
